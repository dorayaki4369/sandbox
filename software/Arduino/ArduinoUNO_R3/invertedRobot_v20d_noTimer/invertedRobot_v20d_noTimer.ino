...
void setup () { //18
  ...
  for ( int i = 0 ; i < 10 ; i++ ) {
    recOmegaI[i] = 0;
  } // 25 ("int" is added instead of line 2 omitted.)
...
void chkAndCtl() {
  ...
  for ( int i = 0 ; i < 45 ; i++ ) {
    // DL27 ("int" is added instead of line 2 omitted.)
  ...
  if ( abs( omegaI ) < 2 ) {
    omegaI = 0;
  } // 57 (The lower bound is less than 2 in this version.)
  recOmegaI[0] = omegaI;
  thetaI = thetaI + omegaI;                                                                                                                                                                                                         
  countS = 0; // 60
  for ( int i = 0 ; i < 10 ; i++ ) {
    // ("int" is added instead of line 2 omitted.)
    if ( abs( recOmegaI[i] ) < 4 ) {
      countS++;
    } // 62 (The lower bound is less than 4 in this version.)
  }
  if ( countS > 9 ) {
    thetaI = 0; // 65
    vE5 = 0;
