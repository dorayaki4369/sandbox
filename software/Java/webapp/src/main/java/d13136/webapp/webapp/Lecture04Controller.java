...
public class Lecture04Controller {
    ...
    public static String omikujiInput() {
    ...
    public static String omikujiOutput(ModelMap modelMap, @RequestParam("name") String name) {
        String result = "吉";
        if (Math.random() < 0.5) {
            result = "大吉";
        }
     ...
     */
    @PostMapping("janken")
    public static String janken(ModelMap modelMap, @RequestParam("janken") String janken) {
    ...
    public static String questionnaire(ModelMap modelMap,
